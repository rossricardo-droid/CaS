...
const COPY = {
  es: {
    ...
    // Botón evidencia (llamados finales)
    evidence: {
      open: {
      ...
      oe: {
        ...
        evidenceBlocks: [
          ...
          },
          {
            ...
            insight: "La estrategia compite contra el propio diseño interno del sistema.",
          },
          {
            ...
            insight: "Cuando habilitadores se diseñan como parte del sistema, la velocidad deja de ser frágil.",
          },
        ],
      },
        ...
        evidenceBlocks: [
          {
            ...
            insight: "Lo que se percibe como problema humano suele ser arquitectura mal diseñada.",
          },
          {
            ...
            insight: "Escalar exige reducir complejidad, no añadir control.",
          },
        ],
      },
      ...
      rl: {
        ...
        evidenceBlocks: [
          ...
          },
          {
            ...
            insight: "La reinvención exige contraste entre práctica local y pensamiento global.",
          },
        ],
      },
    },
        ...
        evidenceBlocks: [
          {
            ...
            insight: "Execution scales when the system protects strategic capacity.",
          },
          {
            ...
            insight: "Strategy competes against the system’s own internal design.",
          },
          {
            ...
            insight: "When enablers are part of the system design, speed stops being fragile.",
          },
        ],
      },
        ...
        evidenceBlocks: [
          {
            ...
            insight: "What looks like a people problem is often an architecture problem.",
          },
          {
            ...
            insight: "Scaling requires reducing complexity—not adding control.",
          },
        ],
      },
      ...
      rl: {
        ...
        evidenceBlocks: [
          ...
          },
          {
            ...
            insight: "Reinvention requires continuous contrast between local practice and global thinking.",
          },
        ],
      },
    },
...
function setEvidenceOpen(open) {
  ...
  // Safety (if elements missing for any reason)
  if (!els.evidence || !els.evidenceToggle || !els.evidenceToggleLabel) return;
